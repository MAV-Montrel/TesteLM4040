...
# 2 "<built-in>" 2
# 1 "AppTesteLM4040.c" 2
# 1 "./AppTesteLM4040.h" 1
# 11 "./AppTesteLM4040.h"
...
# 4 "AppTesteLM4040.c" 2



typedef struct{
  _Bool calibrando;
  _Bool identifica_mudanca;
  _Bool testando;
  _Bool aprovado;
  _Bool reprovado;
}state_t;
...
void AppTesteLM4040_Calibrando(void)
{
    ...
    static uint16_t cont_tempo = 0;
     ...
     difan = LeituraAD.AN3 - LeituraAD.AN2;
...
void AppTesteLM4040_Testando(void)
{
    ...
    tensaoexibe = (float)(erromedido) * 1.21;
...
uint16_t ServiceAD_Media(void)
{
    ...
    for (index = 0; index < 20; index++)
            ...
            valueMean = (uint16_t)(valueAux / 20);
            valueAux = 0;
